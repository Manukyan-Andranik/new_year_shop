...
const translations = {
    en: {
        ...
        'form.customer_name': 'Your Name',
        'form.customer_phone': 'Phone',
        'form.customer_phone.placeholder': '0 XX XXX XXX',
        'form.delivery_date': 'Expected Delivery Date',
        'form.count': 'Quantity',
        'form.names': 'Names',
        'form.toy_type': 'Toy Type',
    ...
    hy: {
        ...
        'checkout.button': 'Ուղարկել Ձմեռ Պապիկին',
        ...
        // Order Modal
        'order.title': '✉️ Նամակ Ձմեռ Պապիկին — Ձեր Ամանորյա Ցանկությունները',
        'order.subtitle': 'Անպայման ստուգենք, որ Ձմեռ Պապիկը ձեր սիրելի խաղալիքները ստանա!',
        'order.preview': 'Պատվերի Նախադիտում',
        'order.items': '{count} խաղալիք',
        'order.total': 'Ընդամենը:',
        'order.empty': 'Ձեր նամակը Ձմեռ Պապիկին դատարկ է!',
        'order.form.name': 'Ձեր Անունը',
        'order.form.email': 'Ձեր Էլ. Փոստը',
        'order.form.phone': 'Ձեր Հեռախոսը',
        'order.form.message': 'Ձեր Նամակը Ձմեռ Պապիկին',
        'order.buttons.back': 'Վերադառնալ Խանութ 🛒',
        'order.buttons.send': 'Ուղարկել Ձմեռ Պապիկին ✨',
        'order.sending': 'Ուղարկվում է...',

        // Success Modal
        'success.title': '💌 Նամակը Ուղարկվել է Ձմեռ Պապիկին!',
        'success.message': 'Ձեր սրտանց Ամանորյա ցանկությունը հենց նոր թռավ ձյան երկնքով դեպի Հյուսիսային բևեռ! 🎄 Ձմեռ Պապիկի էլֆերը արդեն փաթաթում են ձեր ընտրած խաղալիքները ժապավեններով և կախարդական փոշով: Շնորհակալություն Ամանորյա ոգին կենդանի պահելու համար! 🌟',
        'success.signature': '✨ Սիրով և տոնական ուրախությամբ,<br>Ձմեռ Պապիկի Արհեստանոցը 🎅',
        'success.continue': 'Շարունակել Գնումները 🎁',

        // Product Modal
        'product.modal.title': 'Խաղալիքի Անունը',
        'product.modal.price': '$0.00',
        'product.modal.description': 'Խաղալիքի նկարագրություն:',
        ...
        'product.gallery.thumbs': 'Խաղալիքի պատկերներ',

        // Announcements
        'announcement.added': '{name} ավելացվել է ծառին',
        'announcement.order.success': 'Պատվերը հաջողությամբ ուղարկվել է Ձմեռ Պապիկին!',
        ...
        "about.feedback.testimonial3.text": "Հաճախորդների սպասարկումը նույնքան կախարդական էր, որքան խաղալիքները: Նրանք օգնեցին ինձ ընտրել կատարյալ զարդարանքները մեր գրասենյակի Ամանորյա երեկոյի համար:",
        ...
        'offer.select_products': 'Ընտրեք խղալիքներ',
        ...
        'message.select_product': 'Խնդրում ենք ընտրել առնվազն մեկ խաղալիք',
    ...
    ru: {
        ...
        'order.form.message': 'Ваше Письмо Санте',
